...
from air_tests.DailyMission.conftest_daily import setup_unlocked_daily_mission, wait_for_next_day, teardown_app
...
def main():
    try:
        ...
        wrapper.log_info("PASS: Missions reset (assuming cheat works)")
