...
from pages.lucky_spin import LuckySpinPage
from pages.remove_ads import RemoveAds
from pages.setting_page import SettingPage
from air_tests.DailyMission.conftest_daily import setup_with_level, teardown_app
...
def main():
    try:
        ...
        setup_with_level(home_page, cheat, game, ads, 5)
