...
def main():
    try:
        ...
        wrapper.log_info("=== TC23: Watch ads for free exp ===")
        setup_unlocked_daily_mission(home_page, cheat, game, target_level=11)
        daily.open_daily_mission_popup()
        wrapper.log_info("PASS: Ads watched (manual verification needed)")
        wrapper.log_info("=== TC23 PASSED ===")
    except Exception as e:
        wrapper.log_error(f"TC23 failed: {str(e)}\n{traceback.format_exc()}")
