...
def main():
    try:
        ...
        wrapper.log_info("=== TC28: Claim all EXP milestones ===")
        ...
        for m in [30, 70, 100]:
            daily.claim_exp_reward(m)
            sleep(1)
        wrapper.log_info("PASS: All milestones claimed")
        wrapper.log_info("=== TC28 PASSED ===")
    except Exception as e:
        wrapper.log_error(f"TC28 failed: {str(e)}\n{traceback.format_exc()}")
        snapshot(filename="tc28_error.png")
    finally:
        teardown_app()
