...
from .cheat_page import get_template, CheatPage
...
class DailyMissionPage(BasePage):
    ...
    btn_tutorial = get_template("system_function/btn_tutorial.png", (-0.414, -0.794))
    ...
    def complete_tutorial_from_popup(self) -> None:
        if self.wait_for_element(self.tap_to_continue, timeout=10):
            ...
            wrapper.log_info("tap_to_continue doesn't seen yet – maybe it's close")
        self.tap(self.btn_close)
        sleep(1)